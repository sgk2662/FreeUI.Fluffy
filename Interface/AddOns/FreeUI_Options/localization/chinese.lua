...
ns.localization.generalobjectivetracker = "任务追踪框体增强"
ns.localization.generalobjectivetrackerTooltip = "可以自由移动任务追踪框体。\n如果要使用其他任务追踪类插件请先禁用这个选项。"
...
ns.localization.generalshowtreasures = "宝藏标记"
ns.localization.generalshowtreasuresTooltip = "在地图上显示宝藏标记，来自于阿斯兰售卖的藏宝图。"
ns.localization.generalncshadow = "ncShadow"
ns.localization.generalncshadowTooltip = "在屏幕边缘添加一层阴影."
ns.localization.generalemergency = "Emergency"
ns.localization.generalemergencyTooltip = "当你血量或蓝量低于 30% 时播放一个声音提示。"
...
ns.localization.unitframesgradient = "渐变模式"
ns.localization.unitframesgradientTooltip = "头像框体使用渐变色。"
ns.localization.unitframesrectangleAura = "矩形状态图标"
ns.localization.unitframesspellRange = "高级 SpellRange 支持"
ns.localization.unitframesspellRangeTooltip = "启用可对任何敌友目标生效，禁用则只支持队友。"
ns.localization.unitframespowerTypeColor = "能量条染色"
