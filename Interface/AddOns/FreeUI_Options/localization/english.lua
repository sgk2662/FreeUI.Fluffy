...
ns.localization.generalobjectivetracker = "Objectivetracker"
ns.localization.generalobjectivetrackerTooltip = "Restyle the default objectivetracker and make it moveable. You may want to disable this option if you prefer another objectivetracker addon."
...
ns.localization.generalncshadow = "ncShadow"
ns.localization.generalncshadowTooltip = "Creates a shadow overlay on the edge of the screen."
...
ns.localization.unitframesgradientTooltip = ""
ns.localization.unitframesrectangleAura = "Rectangle auras"
ns.localization.unitframesspellRange = "SpellRange plugin support"
ns.localization.unitframesspellRangeTooltip = "Works for any hostile or friendly targets, rather than group members only."
...
ns.localization.tooltipenable = "Enable FreebTip"
ns.localization.tooltipenableTooltip = "Use FreebTip instead of default tooltip.\nDisable to resolve compatibility issues or if you want to use another tooltip addon."
ns.localization.tooltipcursor = "Keeps the tooltip near cursor"
ns.localization.tooltipplayerTitle = "Player title"
ns.localization.tooltipshowRealm = "Player realm"
ns.localization.tooltipshowRank = "Player guild rank"
ns.localization.tooltiphidePvP = "Hide PVP status"
ns.localization.tooltiphideFaction = "Hide faction"
ns.localization.tooltipcolorborderClass = "color border by class"
